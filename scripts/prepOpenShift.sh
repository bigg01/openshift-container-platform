...
((cd /home/$SUDOUSER && git clone https://github.com/bigg01/openshift-container-platform-playbooks.git) || (cd /home/$SUDOUSER/openshift-container-platform-playbooks && git pull))
...
openshift_docker_options= "-l warn --ipv6=false --disable-legacy-registry --bip=10.86.0.100/16 --log-driver json-file --log-opt max-size=20M --log-opt max-file=3"
...
# Prepare glusterfs storage class
